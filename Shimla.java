...
{ 
        ...
        static String a[]={"Delhi","Chattisgarh","Hyderabad","Kolkata","Mumbai","Chennai","Jaipur","Patna","Ranchi","Bhopal"};  
     public static void shimla()throws Exception
    {
        Thread.sleep(70);
            System.out.print("\u000C");
            load();
            ...
            {System.out.print("\u000C");
                System.out.println("Try Again");Thread.sleep(1000);shimla();}
         }
        ...
        switch(ch[0])
           {
            ...
            Thread.sleep(3000);
                ...
                System.out.println("One way flight from "+startingplace+" to Shimla.");
                Flight_Class.Shimla();
                System.out.println("For Detailed bookings of your filghts visit MakeMyFlight.com and login using the same details");
            ...
            Thread.sleep(3000);
                ...
                System.out.println("Round Trip flights from "+startingplace+" to Shimla and\n vice versa.");
                Flight_Class.Shimla();
                System.out.println("For Detailed bookings of your filghts visit MakeMyFlight.com and login using the same details");
                System.out.println("3) The duration of the flight depends on the distance from your\n departure city");
            ...
            Thread.sleep(3000);
             ...
             {
                 System.out.println("TRY AGAIN");enter=obj.readLine();
                 enter=obj.readLine();
                 if(enter.equalsIgnoreCase("done"))
                {
                    Rented_Vehicles.RentedV();
