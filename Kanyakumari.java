...
{ 
        ...
        static String a[]={"Chennai","Bangalore","Hyderabad","Kolkata","Surat","Mumbai","Jaipur","Patna","Ranchi","Ahmedabad"};  
     public static void Kanyakumari()throws Exception
    {
        Thread.sleep(70);
            System.out.print("\u000C");
            load();
            ...
            {System.out.print("\u000C");
                System.out.println("Try Again");Thread.sleep(1000);Kanyakumari();}
         }
        ...
        switch(ch[0])
           {
            ...
            try{no=Integer.parseInt(obj.readLine());}catch(Exception t){System.out.println("INVALID\nTRY AGAIN");no=Integer.parseInt(obj.readLine());}
             ...
             if(no==2){System.out.print("\u000C");kany();}
             if(no==3){BILL.bill();paymentmethod.pay();}
            break;
            case 2:
            double room= 2500.0;int nrooms;
            ...
            Thread.sleep(3000);
                ...
                System.out.println("One way flight from "+startingplace+" to Kanyakumari.");
                Flight_Class.Kanyakumari();
                System.out.println("For Detailed bookings of your filghts visit MakeMyFlight.com and login using the same details");
                ...
                System.out.println("This package is available in Hotel Kanyakumari");
            ...
            Thread.sleep(3000);
                ...
                System.out.println("Round Trip flights from "+startingplace+" to Kanyakumari and\n vice versa.");
                Flight_Class.Kanyakumari();
                System.out.println("For Detailed bookings of your filghts visit MakeMyFlight.com and login using the same details");
                System.out.println("3) The duration of the flight depends on the distance from your\n departure city");
                ...
                System.out.println("This package is available in Hotel Chaitra");
            ...
            Thread.sleep(3000);
                ...
                try{no=Integer.parseInt(obj.readLine());}catch(Exception t){System.out.println("INVALID\nTRY AGAIN");no=Integer.parseInt(obj.readLine());}
                if(no==1){MakeMyReservation.intr();}
                if(no==2){BILL.bill2();Thread.sleep(1000000);paymentmethod.pay();}
                if(no==3){System.out.print("\u000C");kany();}
            }
            else
            {
