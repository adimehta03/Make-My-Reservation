...
{ 
        ...
        static String a[]={"Delhi","Bangalore","Hyderabad","Kolkata","Mumbai","Chennai","Jaipur","Tiruvananthapuram","Ranchi","Pune"};  
     public static void Darjeeling()throws Exception
    {
        Thread.sleep(70);
            System.out.print("\u000C");
            load();
            ...
            {System.out.print("\u000C");
                System.out.println("Try Again");Thread.sleep(1000);Darjeeling();}
         }
        ...
        switch(ch[0])
           {
            ...
            Thread.sleep(3000);
                ...
                System.out.println("One way flight from "+startingplace+" to Darjeeling.");
                Flight_Class.Darjeeling();
                System.out.println("For Detailed bookings of your filghts visit MakeMyFlight.com and login using the same details");
                ...
                System.out.println("This package is available in Hotel Amigos");
            ...
            Thread.sleep(3000);
                ...
                System.out.println("Round Trip flights from "+startingplace+" to Darjeeling and\n vice versa.");
                Flight_Class.Darjeeling();
                System.out.println("For Detailed bookings of your filghts visit MakeMyFlight.com and login using the same details");
                System.out.println("3) The duration of the flight depends on the distance from your\n departure city");
                ...
                System.out.println("This package is available in Hotel Sangling");
