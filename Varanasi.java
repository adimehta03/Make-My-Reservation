...
{ 
    ...
    static String a[]={"Bangalore","Vishakapatnam","Hyderabad","Puducherry","Mumbai","Chennai","Jaipur","Ahmedabad","Ranchi","Raipur"};  
    static BufferedReader obj=new BufferedReader(new InputStreamReader(System.in));
    public static void Varanasi()throws Exception
    {
        Thread.sleep(70);
            System.out.print("\u000C");
            load();
            ...
            {System.out.print("\u000C");
                System.out.println("Try Again");Thread.sleep(1000);Varanasi();}
         }
    ...
    public static void vara()throws Exception
    {
        ...
        System.out.println("8.To see the description of the top 10 tourist destinations of Varanasi press 8...");
        ...
        switch(ch[0])
           {
            ...
            try{no=Integer.parseInt(obj.readLine());}catch(Exception t){System.out.println("INVALID\nTRY AGAIN");no=Integer.parseInt(obj.readLine());}
             ...
             if(no==2){System.out.print("\u000C");vara();}
             if(no==3){BILL.bill();paymentmethod.pay();}
            break;
            case 2:
            double room= 2500.0;int roomno;
            t=Math.ceil(Math.random()*7500);
            System.out.println("Please enter the number of rooms you would like to reserve-");
            try{roomno=Integer.parseInt(obj.readLine());}catch(Exception t){System.out.println("INVALID\nTRY AGAIN");roomno=Integer.parseInt(obj.readLine());}
            cost=roomno*room;
            System.out.println("Just a second..............");
            Thread.sleep(3000);
            ...
            int room_no;
            System.out.println("Please enter the number of rooms you would like to reserve-");
            try{room_no=Integer.parseInt(obj.readLine());}catch(Exception t){System.out.println("INVALID\nTRY AGAIN");room_no=Integer.parseInt(obj.readLine());}
            cost=room_no*room1;
            System.out.println("Just a second..............");
            Thread.sleep(3000);
            ...
            try{days=Double.parseDouble(obj.readLine());}catch(Exception t){System.out.println("INVALID\nTRY AGAIN");days=Integer.parseInt(obj.readLine());}
            double cost;
            double cheapcostingroom=2000.0;
            double middlerangeroom=5000.0;
            double costlyroom=12000.0;
            ...
            try{cost=Double.parseDouble(obj.readLine());}catch(Exception t){System.out.println("INVALID\nTRY AGAIN");cost=Integer.parseInt(obj.readLine());}
            System.out.println("Just a second.........");
            Thread.sleep(3000);
