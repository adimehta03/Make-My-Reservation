...
class Hyderabad
{
        ...
        static int no,travelers,day,far,fare,d;static double t,cost=0;
        static BufferedReader obj=new BufferedReader(new InputStreamReader(System.in));
        static String a[]={"Delhi","Chattisgarh","Bihar","Kolkata","Mumbai","Ahmedabad","Jaipur","Patna","Ranchi","Bhopal"};  
    static void hyderabad()throws Exception
    {
        Thread.sleep(70);
            ...
            {System.out.print("\u000C");
                System.out.println("Try Again");Thread.sleep(1000);hyderabad();}
         }
        ...
        switch(ch[0])
           {
            ...
            Thread.sleep(3000);
             ...
             System.out.println("1)Flight Name-Air Costa.");
             System.out.println("Round trip flights ,i.e, flights from "+startingplace+"\n to Hyderabad and vice versa.");
             Flight_Class.Hyderabad();
            ...
            Thread.sleep(3000);
                ...
                System.out.println("One way flight from "+startingplace+" to Hyderabad.");
                Flight_Class.Hyderabad();
                System.out.println("For Detailed bookings of your filghts visit MakeMyFlight.com and login using the same details");
                ...
                System.out.println("This package is available in Hotel Raaj");
            ...
            Thread.sleep(3000);
                ...
                System.out.println("This package includes:");
                System.out.println("1) Flight name-IndiGo Airlines.");
                System.out.println("Round Trip flights from "+startingplace+" to Hyderabad and\n vice versa.");
                Flight_Class.Hyderabad();
                System.out.println("For Detailed bookings of your filghts visit MakeMyFlight.com and login using the same details");
                System.out.println("3) The duration of the flight depends on the distance from your\n departure city");
                ...
                System.out.println("This package is available in Hotel Biryani");
            ...
            double cost;
            double cheapcostingroom=1700.0;
            double middlerangeroom=3280.0;
            double costlyroom=15300.0;
