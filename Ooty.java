...
{ 
        ...
        static String a[]={"Ahmedabad","Chattisgarh","Guwahati","Patna","Mumbai","Bihar","Kolkata","Jaipur","Ranchi","Bhopal"};  
     public static void ooty()throws Exception
    {
        Thread.sleep(70);
            System.out.print("\u000C");
            load();
            ...
            {System.out.print("\u000C");
                System.out.println("Try Again");Thread.sleep(1000);ooty();}
         }
        ...
        switch(ch[0])
           {
            ...
            Thread.sleep(3000);
                ...
                System.out.println("One way flight from "+startingplace+" to ooty.");
                Flight_Class.ooty();
                System.out.println("For Detailed bookings of your filghts visit MakeMyFlight.com and login using the same details");
                ...
                System.out.println("This package is available in Hotel Sky High");
            ...
            Thread.sleep(3000);
                ...
                System.out.println("Round Trip flights from "+startingplace+" to ooty and\n vice versa.");
                Flight_Class.ooty();
                System.out.println("For Detailed bookings of your filghts visit MakeMyFlight.com and login using the same details");
                System.out.println("3) The duration of the flight depends on the distance from your\n departure city");
                ...
                System.out.println("This package is available in Hotel Heavens");
